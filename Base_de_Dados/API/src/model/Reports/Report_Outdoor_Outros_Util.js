...
Report.hasOne(Report_Outdoor_Outros_Util, {foreignKey: { allowNull: false, type: Sequelize.INTEGER }});
Report_Outdoor_Outros_Util.belongsTo(Report); // vai retornar a FK id_local
